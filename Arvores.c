...
int main(){
	...
	/* Inserindo valores ABB */
	 srand((unsigned)time(NULL));
	start = (double) clock() / CLOCKS_PER_SEC; // inicia a contagem
	for (i = 0; i < TAM_MAX-1; i++){	 /* gerando valores aleatórios entre zero e 100000 */
